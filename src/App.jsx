          ...
          <div className="max-w-6xl mx-auto px-6 md:px-8 py-16 md:py-20 flex flex-col gap-10">
            ...
            <div className="flex flex-col md:flex-row items-center gap-8">
              ...
              <div>
                ...
                >
                  Hey, I’m Imeth! I connect science, humanity, and innovation to shape the future
                  of medicine.
                </motion.h1>
                <motion.div
                  initial={{ opacity: 0, y: 10 }}
                ...
                >
                  I’m into prevention-first thinking and turning evidence into action—from campus
                  overdose response to imaging-based early detection.
                </motion.p>
