      ...
      <div className="mt-10 grid md:grid-cols-12 gap-8">
        <main className="md:col-span-8 space-y-10">
          ...
          <div className="flex flex-wrap gap-3 pt-2">
            <a href="#/journey" className="inline-flex items-center gap-2 rounded-xl px-4 py-2 ring-1 ring-black/10 dark:ring-white/10 bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-50 hover:shadow-sm">
              ← Back to My Journey
            </a>
            <a href="#/contact" className="bg-indigo-600 text-white inline-flex items-center gap-2 rounded-xl px-4 py-2 hover:opacity-90">
              Let’s collaborate
            </a>
          </div>
        </main>
